    ...
    <div class="max-w-4xl mx-auto">
        ...
        @if ($formSubmitted)
            <div class="bg-green-50 border border-green-200 rounded-lg p-8 text-center shadow-sm">
                ...
                <h3 class="text-2xl font-bold text-green-800 mb-3">Formulário Submetido!</h3>
                <p class="text-green-700 text-lg mb-6">{{ $successMessage }}</p>
                <div class="bg-green-100 border border-green-300 rounded-lg p-4 inline-block mb-6">
                    <p class="text-green-800 font-medium">✅ A sua submissão foi recebida com sucesso</p>
                </div>
                <div class="mt-6">
        ...
        @elseif (!$formAvailable)
            <div class="bg-red-50 border border-red-200 rounded-lg p-8 text-center shadow-sm">
                <div class="flex items-center justify-center gap-3 mb-4">
                ...
                <h3 class="text-2xl font-bold text-red-800 mb-3">Formulário Indisponível</h3>
                <p class="text-red-700 text-lg mb-6">
                    {{ $unavailableMessage ?? 'Não é possível aceder a este formulário no momento.' }}</p>
                <div class="bg-red-100 border border-red-300 rounded-lg p-4 inline-block">
                    <p class="text-red-800 font-medium">❌ Não é possível aceder a este formulário no momento</p>
                </div>
                <div class="mt-6">
                    <button wire:click="closePage" type="button"
                        ...
                        @if ($isSubmitting)
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <span class="text-blue-800 font-medium">A processar o formulário...</span>
                                </div>
                            </div>
                        @endif
                    </form>
